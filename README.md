...
ブラウザの「ホーム画面に追加」または「アプリをインストール」で、スマホのホーム画面にアイコン付きで追加できます。

### アイコンの設定

提供されたデザイン（笑い顔＋100点＋星）をアイコンにする場合：
1. `icons/icon_copy.bat` をダブルクリックして実行
2. `icons/icon-512.png` が作成されます
3. 変更をGitにプッシュして再デプロイ

※ 画像を手動で `icons/icon-512.png` に配置しても構いません。
